...
## Shipped: v0.11.0 — Notebook export (September 2026)
...
## Next: v0.12 — Chemistry-aware suggestions (in design on branch `v08-slot-based`, named before renumbering)
...
SSO/MFA, fine-grained permissions, deployment automation, penetration testing, billing, SLAs, and live ELN/LIMS connectors (beyond the open `.eln` export) are parked until there is evidence of demand from real teams. They belong to a sales motion this project is not currently running.
