"""Qualification dossier generation for Reformulation Assurance v0.8.0."""
...
<div class="footer">Generated by Reformulation Assurance v0.8.0. Verify the evidence hash and the SHA256SUMS file before relying on an exported copy.</div>
</body></html>"""
