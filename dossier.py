"""Qualification dossier generation for Reformulation Assurance v0.6.2."""
...
def compute_evidence_hash(store: ProductStore, project_id: str) -> str:
    return sha256(_canonical_json(scientific_evidence_bundle(store, project_id))).hexdigest()
    ...
    *,
    ...
    if not current_approvals.empty:
        ...
        approval_view = current_approvals[[
            ...
            "signed_at", "matches_current_evidence", "comment"
        ]]
    else:
...
<div class="footer">Generated by Reformulation Assurance v0.6.2. Verify the evidence hash and the SHA256SUMS file before relying on an exported copy.</div>
</body></html>"""
...
def generate_dossier(
    ...
    *,
    ...
    files: dict[str, bytes] = {
        ...
        "approvals.csv": _df_csv(approvals),
